...
void log_leer_archivo(t_log* logger, uint32_t pid, char* nombre_archivo, int tamanio, void* puntero){
    log_info(logger, "PID: %d - Leer Archivo: %s - Tamaño a Leer: %d - Puntero Archivo: %p", pid, nombre_archivo, tamanio, (void*) puntero);
}

void log_escribir_archivo(t_log* logger, uint32_t pid, char* nombre_archivo, int tamanio, void* puntero){
    log_info(logger, "PID: %d - Escribir Archivo: %s - Tamaño a Escribir: %d - Puntero Archivo: %p", pid, nombre_archivo, tamanio, (void*) puntero);
}
