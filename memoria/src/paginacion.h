...
*/ // el bitmap es un array dinámico donde el largo son la cantidad de marcos totales en memoria y su valor varía entre 0: marco libre y 1: marco ocupado por algún proceso

typedef struct{   
    uint32_t id_frame;   // numero de marco asociado a la página
...
extern uint8_t* bitmap_frames_libres; // array dinámico donde su length = cantidad de frames/marcos totales en memoria, que guarda por posición valores 0: marco libre; y 1: marco ocupado por algún proceso
extern int cantidad_frames_totales;
